...
select
    ...
    'opportunity closed lost' as event_name,
...
from opportunities_with_full_circle_lead_journeys where close_date is not null and opportunity_stage in ('7-Closed Lost','Closed Lost')
