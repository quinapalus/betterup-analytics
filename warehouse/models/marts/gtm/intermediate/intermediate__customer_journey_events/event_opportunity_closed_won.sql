...
select
    ...
    sfdc_account_id,
    sfdc_opportunity_id,
    close_date as event_at,
    'opportunity closed won' as event_name,
    ...
    object_construct(
        ...
        'management_targets_target','Revenue',
...
from opportunities_with_full_circle_lead_journeys where close_date is not null and opportunity_stage in ('7- Closed Won','Closed Won')
