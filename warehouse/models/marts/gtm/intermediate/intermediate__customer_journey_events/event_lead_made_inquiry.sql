...
select
    ...
    inquiry_date as event_at,
    'lead made inquiry' as event_name,
    ...
    object_construct(
        ...
        'person_inquiry_sequence', row_number() over(partition by email order by inquiry_date asc)
    ) as attributes

from full_circle_lead_journeys where inquiry_date is not null
