...
select
    ...
    sfdc_account_id,
    sfdc_opportunity_id,
    stage_1_date as event_at,
    'opportunity reached stage 1' as event_name,
    ...
    object_construct(
        ...
        'management_targets_target',case when management_targets_line_of_business in ('New/Upsell','Expand') then 'Pipeline' end,
...
from opportunities_with_full_circle_lead_journeys where stage_1_date is not null
