-- All product subscription assignment invite events
...
SELECT
  {{ dbt_utils.surrogate_key(['member_id','event_at','event_object','associated_record_id'])}} as invited_product_subscription_assignment_id,
  member_id,
  event_at,
