...
final as (
  ...
  QUALIFY ROW_NUMBER()OVER(PARTITION BY member_reporting_group_assignment_key, rga.member_id, rga.reporting_group_id, rga.associated_assignment_id ORDER BY wp360.event_at DESC) = 1
