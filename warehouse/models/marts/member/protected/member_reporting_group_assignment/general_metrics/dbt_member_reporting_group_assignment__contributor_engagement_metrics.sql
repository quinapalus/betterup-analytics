...
final as (
    SELECT
        {{ dbt_utils.surrogate_key(['rga.member_id', 'rga.reporting_group_id', 'rga.associated_assignment_id', 'fe.contributor_id']) }} as member_reporting_group_assignment_contributor_key,
        rga.member_id,
        fe.contributor_id,
    ...
    GROUP BY
        member_reporting_group_assignment_contributor_key,
        rga.member_id,
        fe.contributor_id,
        rga.associated_assignment_id,
        rga.reporting_group_id
