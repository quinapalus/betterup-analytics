WITH reporting_group_organizations AS (
  ...
  select * from {{ source('app', 'reporting_group_organizations') }}

),

current_reporting_group_organizations as (

  select
        id as reporting_group_organization_id,
...
archived_reporting_group_organizations as (
/*
...
*/
  ...
  select
        ...
        organization_id,
        reporting_group_id
  from {{ ref('base_app__reporting_group_organizations_historical') }}
)
...
union
{% endif -%}
select * from current_reporting_group_organizations
